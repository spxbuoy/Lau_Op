...
# Banner
echo -e "${RED}======================================${NC}"
echo -e "${YELLOW}        ⚡ GLITCH SERVER SETUP ⚡${NC}"
echo -e "${CYAN}        Unleash Your Power 2025${NC}"
echo -e "${RED}======================================${NC}"
echo ""

# Savage animation - loading effect
frames=("⚡" "🔥" "💀" "💥" "⚡" "🔥")
for i in {1..3}; do
    for frame in "${frames[@]}"; do
        echo -ne "${YELLOW}Initializing ${frame} ...${NC}\r"
        sleep 0.3
    done
done

echo -e "\n${GREEN}Ready to Dominate!${NC}"
sleep 2
###### IZIN SC 
